...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('news_site', models.CharField(blank=True, max_length=30, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('news_date', models.CharField(blank=True, max_length=20, null=True)),
                ('news_title', models.CharField(blank=True, max_length=80, null=True)),
                ('news_text_sm', models.TextField()),
                ('url_in', models.CharField(blank=True, max_length=100, null=True)),
                ('news_writer', models.CharField(blank=True, max_length=20, null=True)),
