...
#     posts = TotalnewsKT.objects.all()
#     print(TotalnewsKT.news_date, TotalnewsKT.total_keywords)
#     #NewsSites테이블의 모든 객체 불러와서 posts변수에 저장
...
def post_view(request):
    ...
    return render(request, '../know_arc_pjt/templates/main.html', context)
