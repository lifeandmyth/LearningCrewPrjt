...
from .models import RelatedKeywords
...
# 20230627 왕예슬 통합
from .models import TotalTKeyrank, MainCustomuser, CustomUser, KeywordsTechworld, KeywordsRecentit, KeywordsItworld, KeywordsBloter, KeywordsCwn, KeywordsItbiz, TotalnewsKT
...
def main(request) :
    ...
    # close
    # context_full = context.update(context_mwc)
