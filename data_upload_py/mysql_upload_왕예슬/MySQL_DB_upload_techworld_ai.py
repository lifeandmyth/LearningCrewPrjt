...
sql_techworld_ai_data_t ="""
CREATE TABLE IF NOT EXISTS sql_techworld_ai_data(
...
cur.execute(sql_techworld_ai_data_t)

# csv파일을 넣기
import csv

# itbiz csv tech 
f = open('know_arc_pjt/data_crawling_D/data_crawling_왕예슬/techworld_ai_metaverse_robot.csv','r', encoding='utf8')
rdr = csv.reader(f)
next(rdr)
...
cur.executemany("INSERT INTO sql_techworld_ai_data(news_date, news_title, news_text_sm, url_in, news_writer, thumb_addr) VALUES (%s,%s,%s,%s,%s,%s)", total_news_list)
