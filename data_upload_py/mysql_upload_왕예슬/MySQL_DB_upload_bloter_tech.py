...
sql_bloter_t_data_t ="""
CREATE TABLE IF NOT EXISTS sql_bloter_t_data(
...
cur.execute(sql_bloter_t_data_t)
...
# itbiz csv tech 
f = open('know_arc_pjt/data_crawling_D/data_crawling_왕예슬/bloter_tech.csv','r', encoding='utf8')
rdr = csv.reader(f)
next(rdr)
...
cur.executemany("INSERT INTO sql_bloter_t_data(news_date, news_title, news_text_sm, url_in, news_writer, tags_string, thumb_addr) VALUES (%s,%s,%s,%s,%s,%s,%s)", total_news_list)
