...
total_t_keyrank_t ="""
CREATE TABLE IF NOT EXISTS total_t_keyrank(
...
# itbiz csv tech 
f = open('data_crawling_D/keywords/test.csv','r', encoding='utf8')
rdr = csv.reader(f)
next(rdr)
...
cur.executemany("INSERT INTO total_t_keyrank(keywords,cnt) VALUES (%s,%s)", key_list)
