...
sql_cwn_data_t ="""
CREATE TABLE IF NOT EXISTS sql_cwn_data(
...
# itbiz csv tech 
f = open('know_arc_pjt/data_crawling_D/data_crawling_김경민/cwn.kr/2023-06-20-16.csv','r', encoding='utf8')
rdr = csv.reader(f)
next(rdr)
...
# thumb_addr VARCHAR(100) NOT NULL,
cur.executemany("INSERT INTO sql_cwn_data(news_date, news_title, news_text_sm, url_in, news_writer, tags_string, thumb_addr) VALUES (%s,%s,%s,%s,%s,%s,%s)", total_news_list)
