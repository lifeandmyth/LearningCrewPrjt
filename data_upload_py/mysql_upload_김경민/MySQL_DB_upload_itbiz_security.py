...
sql_itbiz_security_data_t ="""
CREATE TABLE IF NOT EXISTS sql_itbiz_security_data(
...
cur.execute(sql_itbiz_security_data_t)
...
# itbiz csv tech 
f = open('know_arc_pjt/data_crawling_D/data_crawling_김경민/itbiznews.com/news_itbz_security_data/2023-06-20-10.csv','r', encoding='utf8')
rdr = csv.reader(f)
next(rdr)
...
# thumb_addr VARCHAR(100) NOT NULL,
cur.executemany("INSERT INTO sql_itbiz_security_data(news_date, news_title, news_text_sm, url_in, news_writer, tags_string, thumb_addr) VALUES (%s,%s,%s,%s,%s,%s,%s)", total_news_list)
